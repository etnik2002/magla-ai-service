...
/** @internal */
export const GetTeamsTeams$inboundSchema = z.union([TeamLimited$inboundSchema, z.record(z.any())]);
/** @internal */
export const GetTeamsTeams$outboundSchema = z.union([TeamLimited$outboundSchema, z.record(z.any())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */

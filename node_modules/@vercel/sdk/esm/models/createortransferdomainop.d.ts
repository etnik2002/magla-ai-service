...
export type CreateOrTransferDomainRequestBody = CreateOrTransferDomainRequestBody2 | CreateOrTransferDomainRequestBody1 | CreateOrTransferDomainRequestBody3;
export type CreateOrTransferDomainRequest = {
    ...
    requestBody: CreateOrTransferDomainRequestBody2 | CreateOrTransferDomainRequestBody1 | CreateOrTransferDomainRequestBody3;
};
/**
...
/** @internal */
export type CreateOrTransferDomainRequestBody$Outbound = CreateOrTransferDomainRequestBody2$Outbound | CreateOrTransferDomainRequestBody1$Outbound | CreateOrTransferDomainRequestBody3$Outbound;
/** @internal */
...
export type CreateOrTransferDomainRequest$Outbound = {
    teamId?: string | undefined;
    slug?: string | undefined;
    RequestBody: CreateOrTransferDomainRequestBody2$Outbound | CreateOrTransferDomainRequestBody1$Outbound | CreateOrTransferDomainRequestBody3$Outbound;
};
/** @internal */
